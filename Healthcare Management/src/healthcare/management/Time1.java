 ...
 * @author Xia
 */
public class Time1 extends javax.swing.JFrame {

    /**
     * Creates new form Time
     */
    public Time1(String getName) {
        this.Name = getName;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Time == null || Time.isEmpty()) {
            ...
            new Reminder(Name,Time,null,null).setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Time1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
